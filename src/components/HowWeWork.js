  ...
  return (
    <section>
      ...
      <div className="text-center">
        ...
        <ContentTitle>
          Built on <span className="text-deep-moss-green">Precision</span> ,Driven by <span className="text-deep-moss-green"> Excellence</span>
        </ContentTitle>
      </div>
      <PauseOnHover
        dots={false}
        ...
        {worker.map((work)=>(
            <div key={work.id} className="col-sm-12">
                <div className="border-light-silver p-4 mx-2 rounded-4">
                    ...
                    <h5 className="h4 fw-600 mb-3 mt-3 text-eerie-black ">{work.title}</h5>
                    <p>{work.para}</p>
                </div>
            </div>
